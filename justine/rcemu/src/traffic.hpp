...
public:
  ...
  Traffic ( int size, const char * shm_segment, double catchdist, TrafficType type = TrafficType::NORMAL, int minutes = 10, int delay_in = 200 )
    :m_size ( size ), m_catchdist ( catchdist ), m_type ( type ), m_minutes ( minutes ), m_delay(delay_in)
  {
